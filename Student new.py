...
class Student:
    ...
    def to_study(self):
        print("Time to study")
        logging.INFO("Time to study")
        self.progress += 0.12
        self.gladness -= 3

    def to_sleep(self):
        print("I will sleep")
        logging.INFO("I will sleep")
        self.gladness += 3

    def to_chill(self):
        print("Rest time")
        logging.INFO("Rest time")
        self.gladness += 5
        self.progress -= 0.1
    ...
    def is_alive(self):
        if self.progress < -0.5:
            ...
            logging.INFO("Passed externally...")
            self.alive = False
...
class Money:
    ...
    def to_work(self):
        ...
        logging.INFO("Need to earn some money")
        self.gladness -= 2
        self.progress -= 1
        self.money += 5
    ...
    def to_shopping(self):
        ...
        logging.INFO("I have money, I'll go buy myself something")
        self.gladness += 2
        self.progress -= 1
        self.money -= 10
class Pet:
    ...
    def eat(self):
        print("Cat eating.")
        logging.INFO("Cat eating.")


    def sleep(self):
        print("Cat sleeping.")
        logging.INFO("Cat sleeping.")
